...
// No exemplo acima são utilizadas variáveis de parâmetro: chave = valor
@Controller
...
public class UsuarioController {
    ...
    @PostMapping("/")
    public @ResponseBody Integer addUsuario (@RequestBody Usuario objUsuario) {
    ...
    // Nesse exemplo é utilizada a variável de path (caminho)
    @GetMapping("/{id}")
    ...
    @PutMapping("/")
    public @ResponseBody Usuario atualizar(@RequestBody Usuario objUsuario) {
        uRepository.save(objUsuario);
        return objUsuario;
    }
